...
#begin update_one()
col.update_one({"student_id": "1007"}, {"$set": {"last_name": "Smith"}})
#change data back
#col.update_one({"student_id": "1007"}, {"$set": {"last_name": "Bailey"}})
    
#begin find_one()
print("\n-- DISPLAYING STUDENT DOCUMENT FROM find_one() QUERY --")
#get only student with student_id 1008
student = col.find_one({'student_id': "1007"})
